      ...
      <div class="row col-12" style="height: 60px">
        <div class="col-2 pt-3">
          <ul class="list-unstyled ms-3">
            <a class="navbar-brand" href="#"> <img src="img/Logo.png" alt="" width="80" height="50" class="d-inline-block align-text-top"> <span class="text-warning">DAP</span>POLITEKNIK</a>
          </ul>
        ...
        >
          <ul class="d-flex list-unstyled">
            ...
            <li class="nav-item dropdown">
              ...
              >
                <li><a class="dropdown-item" href="login page.php">Log in</a></li>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="Usrname">
                        </div>
                        <div class="form-group">
                            <label>Email</label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="password" name="password"  placeholder="Masukkan Password"></input>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="fact-item bg-light rounded text-center h-100 p-5">
              ...
              <a href="#"><h5 class="mb-3">Pengajuan DAP</h5></a>
            </div>
          </div>
        </div>
      </div>
      <div class="container mt-4">
        <div class="row g-4">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="fact-item bg-light rounded text-center h-100 p-5">
              <i class="fas fa-file-medical fa-4x text-primary mb-4"></i>
              <h5 class="mb-3">Riwayat Iuran</h5>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="fact-item bg-light rounded text-center h-100 p-5">
              <i class="fas fa-plus fa-4x text-primary mb-4"></i>
